...
train_original = pd.read_csv('https://github.com/RushikeshNamde/credit/blob/main/train.csv')

test_original = pd.read_csv('https://github.com/RushikeshNamde/credit/blob/main/test.csv')
